...
import io.github.shino0526y.book_api.generated.jooq.keys.AUTHORS_PKEY
import io.github.shino0526y.book_api.generated.jooq.keys.BOOK_AUTHORS__FK_BOOK_AUTHORS_AUTHOR
import io.github.shino0526y.book_api.generated.jooq.tables.BookAuthors.BookAuthorsPath
import io.github.shino0526y.book_api.generated.jooq.tables.Books.BooksPath
...
open class Authors(
     ...
     */
    val CREATED_AT: TableField<AuthorsRecord, OffsetDateTime?> = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")

    /**
     * The column <code>public.authors.updated_at</code>.
     */
    val UPDATED_AT: TableField<AuthorsRecord, OffsetDateTime?> = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")
    ...
    override fun getChecks(): List<Check<AuthorsRecord>> = listOf(
        Internal.createCheck(this, DSL.name("authors_birth_date_not_in_future"), "((birth_date <= CURRENT_DATE))", true)
    )

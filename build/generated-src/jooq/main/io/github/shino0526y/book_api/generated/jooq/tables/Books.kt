 ...
 */
package io.github.shino0526y.book_api.generated.jooq.tables


import io.github.shino0526y.book_api.generated.jooq.Public
import io.github.shino0526y.book_api.generated.jooq.indexes.IDX_BOOKS_PUBLICATION_STATUS
import io.github.shino0526y.book_api.generated.jooq.keys.BOOKS_PKEY
import io.github.shino0526y.book_api.generated.jooq.keys.BOOK_AUTHORS__FK_BOOK_AUTHORS_BOOK
import io.github.shino0526y.book_api.generated.jooq.tables.Authors.AuthorsPath
import io.github.shino0526y.book_api.generated.jooq.tables.BookAuthors.BookAuthorsPath
...
open class Books(
     ...
     */
    val PRICE: TableField<BooksRecord, BigDecimal?> = createField(DSL.name("price"), SQLDataType.NUMERIC(12, 2).nullable(false), this, "")
     ...
     */
    val CREATED_AT: TableField<BooksRecord, OffsetDateTime?> = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")

    /**
     * The column <code>public.books.updated_at</code>.
     */
    val UPDATED_AT: TableField<BooksRecord, OffsetDateTime?> = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")
    ...
    override fun getIndexes(): List<Index> = listOf(IDX_BOOKS_PUBLICATION_STATUS)
    ...
    override fun getChecks(): List<Check<BooksRecord>> = listOf(
        Internal.createCheck(this, DSL.name("books_price_non_negative"), "((price >= (0)::numeric))", true),
        Internal.createCheck(this, DSL.name("books_publication_status_valid"), "(((publication_status)::text = ANY ((ARRAY['UNPUBLISHED'::character varying, 'PUBLISHED'::character varying])::text[])))", true)
    )

...
import io.github.shino0526y.book_api.generated.jooq.indexes.IDX_BOOK_AUTHORS_AUTHOR_ID
import io.github.shino0526y.book_api.generated.jooq.keys.BOOK_AUTHORS_PKEY
...
open class BookAuthors(
    ...
    override fun getIndexes(): List<Index> = listOf(IDX_BOOK_AUTHORS_AUTHOR_ID)
    ...
    fun authors(): AuthorsPath {
        if (!this::_authors.isInitialized)
            _authors = AuthorsPath(this, BOOK_AUTHORS__FK_BOOK_AUTHORS_AUTHOR, null)
    ...
    fun books(): BooksPath {
        if (!this::_books.isInitialized)
            _books = BooksPath(this, BOOK_AUTHORS__FK_BOOK_AUTHORS_BOOK, null)
